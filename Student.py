...
if __name__ == '__main__':
    stud = Student("Алексей", "Алексеевич", "Бормотов", Path('lessons.csv'))
    print(stud)
    stud.new_estimate("русский язык", 3)
    stud.new_estimate("физика", 2)
    stud.new_estimate("математика", 3)
    stud.new_estimate("русский язык", 5)
    stud.new_estimate("математика", 33, "test")
    stud.new_estimate("математика", 74, "test")
    stud.new_estimate("русский язык", 29, "test")
    stud.new_estimate("русский язык", 50, "test")
    print(stud)
